...
p32_preFactor_CF("DEU","ngcc") = -0.5;
p32_preFactor_CF("DEU","ngccc") = -0.5;
p32_preFactor_CF("DEU","gaschp") = -0.5;
p32_preFactor_CF("DEU","igcc") = -1;
p32_preFactor_CF("DEU","igccc") = -1;
p32_preFactor_CF("DEU","pc") = -1;
p32_preFactor_CF("DEU","coalchp") = -1;
p32_preFactor_CF("DEU","tnrs") = 0.2;
p32_preFactor_CF("DEU","fnrs") = 0.2;
p32_preFactor_CF("DEU","ngt") = -0.5;
p32_preFactor_CF("DEU","windoff") = -0.2;
p32_preFactor_CF("DEU","dot") = 0.5;
p32_preFactor_CF("DEU","wind") = -0.2;
...
p32_preFactor_MV("DEU","ngcc") = -5;
p32_preFactor_MV("DEU","ngccc") = -5;
p32_preFactor_MV("DEU","gaschp") = -5;
p32_preFactor_MV("DEU","igcc") = -3;
p32_preFactor_MV("DEU","igccc") = -3;
p32_preFactor_MV("DEU","pc") = -3;
p32_preFactor_MV("DEU","coalchp") = -3;
p32_preFactor_MV("DEU","tnrs") = -1;
p32_preFactor_MV("DEU","fnrs") = -1;
p32_preFactor_MV("DEU","ngt") = -5;
