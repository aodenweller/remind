...
p32_PyPSA_MarkupSupply(tPy32,regPy32,tePy32) = 0;
p32_PyPSA_MarkupSupplyAvg(tPy32,regPy32,tePy32) = 0;
p32_PyPSA_MarkupDemand(tPy32,regPy32,loadPy32) = 0;
p32_PyPSA_MarkupDemandAvg(tPy32,regPy32,loadPy32) = 0;
p32_PyPSA_MarketValueSupply(tPy32,regPy32,tePy32) = 0;
p32_PyPSA_SectoralElectricityPrices(tPy32,regPy32,loadPy32) = 0;
p32_PyPSA_AverageElectricityPrice(tPy32,regPy32) = 0;
...
p32_lastCap(tPy32,regPy32,tePy32) = 0;
p32_PyPSA_tech_iter(tPy32,regPy32,tePy32,iteration,paramsPy32) = 0;
p32_PyPSA_load_iter(tPy32,regPy32,loadPy32,iteration,paramsPy32) = 0;
p32_PyPSA_scalar_iter(tPy32,regPy32,iteration,paramsPy32) = 0;
