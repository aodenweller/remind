...
parameters
    ...
    p32_PyPSA_ElecPrice_iter(iteration,ttot,all_regi)       "PyPSA import calc: Electricity prices in iterations [$/MWh]"
    p32_PyPSA_ElecPriceAvg(ttot,all_regi)                   "PyPSA import calc: Electricity prices averaged over iterations [$/MWh]"
