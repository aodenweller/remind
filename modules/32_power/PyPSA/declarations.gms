...
$ifthen "%c32_pypsa_trade%" == "on"
    ...
    q32_TradeImport(ttot,all_regi)                                  "PyPSA coupling: Anticipation factor equation for electricity trade import"
    q32_TradeExport(ttot,all_regi)                                  "PyPSA coupling: Anticipation factor equation for electricity trade export"
