...
$endif
    ...
    tePy32(all_te)              "REMIND SE electricity technologies coupled to PyPSA"
        /biochp, bioigcc, bioigccc, ngcc, ngccc, gaschp, igcc, igccc, coalchp, tnrs, fnrs, ngt, windoff, dot, wind, hydro, spv/  !! TODO: What about CSP and geohdr?

    tePyDisp32(all_te)          "REMIND dispatchable SE electricity technologies (without grades)"
        /biochp, bioigcc, bioigccc, ngcc, ngccc, gaschp, igcc, igccc, coalchp, tnrs, fnrs, ngt, dot/
