...
pCapexYear <- ggplot() +
  ...
  geom_point(data = dataCapexPyPSArm, aes(x = year, y = value, color = technology)) +
...
pCapexIter <- ggplot() +
  ...
  geom_point(data = dataCapexPyPSArm, aes(x = iteration, y = value, color = technology)) +
  scale_color_manual(name = "Technology\n(directly from REMIND)",
                     values = colorsTech,
                     labels = namesTech) +
...
pFOMYear <- ggplot() +
  ...
  geom_point(data = dataFOMPyPSArm, aes(x = year, y = value, color = technology)) +
  scale_color_manual(name = "Technology\n(directly from REMIND)",
                     values = colorsTech,
                     labels = namesTech) +
...
pLifetimes <- ggplot() +
  ...
  geom_point(data = dataLifetimesPyPSArm, aes(x = year, y = value, color = technology)) +
  scale_color_manual(name = "Technology\n(directly from REMIND)",
                     values = colorsTech,
                     labels = namesTech) +
...
pVOMTechIter <- ggplot() +
  ...
  geom_point(data = dataVOMPyPSArm, aes(x = iteration, y = value, color = technology)) +
  scale_color_manual(name = "Technology\n(directly from REMIND)",
                     values = colorsTech,
                     breaks = namesTech) +
...
pEtaTechYear <- ggplot() +
  ...
  geom_point(data = dataEtaPyPSArm, aes(x = year, y = value, color = technology)) +
  scale_color_manual(name = "Technology\n(directly from REMIND)",
                     values = colorsTech,
                     breaks = namesTech) +
  labs(x = "Year", y = "Efficiency") +
  ggtitle("Efficiencies over years") +
  facet_grid(technology ~ iteration, labeller = labeller(technology = namesTech)) +
  theme(legend.position = "none")
...
pEtaTechIter <- ggplot() +
  ...
  geom_point(data = dataEtaPyPSArm, aes(x = iteration, y = value, color = technology)) +
  scale_color_manual(name = "Technology\n(directly from REMIND)",
                     values = colorsTech,
                     breaks = namesTech) +
  ...
  facet_grid(technology ~ year, labeller = labeller(technology = namesTech)) +
  theme(legend.position = "none")
...
pFuelCostsYear <- ggplot() +
  ...
  geom_point(data = dataFuelCostsPyPSArm, aes(x = year, y = value, color = technology)) +
  scale_color_manual(name = "Technology\n(directly from REMIND)",
                     values = colorsTech,
                     labels = namesTech) +
...
print(pFuelCostsYear + facet_wrap(~ iteration, scales = "free"))
...
pFuelCostsIter <- ggplot() +
  ...
  scale_shape_manual(name = NULL,
                     values = c("Non-avg. value" = 4)) +
  geom_point(data = dataFuelCostsPyPSArm, aes(x = iteration, y = value, color = technology)) +
  scale_color_manual(name = "Technology\n(directly from REMIND)",
                     values = colorsTech,
                     labels = namesTech) +
...
print(pFuelCostsIter + facet_wrap(~ year, scales = "free"))
...
pCO2intYear <- ggplot() +
  ...
  geom_point(data = dataCO2intPyPSArm, aes(x = year, y = value, color = technology)) +
  scale_color_manual(name = "Technology\n(directly from REMIND)",
                     values = colorsTech,
                     breaks = namesTech) +
...
pCO2intIter <- ggplot() +
  ...
  geom_point(data = dataCO2intPyPSArm, aes(x = iteration, y = value, color = technology)) +
  scale_color_manual(name = "Technology\n(directly from REMIND)",
                     values = colorsTech,
                     breaks = namesTech) +
...
dataCapDiff <- full_join(dataCapREMINDplot, dataCapPyPSAplot,
                  by = c("year", "region", "technology", "iteration")) %>%
  group_by(year, region, iteration) %>%
...
# Calculate relative difference between models
dataGenDiff <- full_join(dataGenREMIND, dataGenPyPSA,
                  by = c("year", "region", "technology", "iteration")) %>%
  group_by(year, region, iteration) %>%
  mutate(relDiff = 100 * (value.x - value.y) / sum(value.x))
