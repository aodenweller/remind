...
pFuelCostsYear <- ggplot() +
  ...
  ggtitle("Fuel costs over years", "Smoothed over iterations")
...
pFuelCostsIter <- ggplot() +
  ...
  scale_x_continuous(breaks = rmIterations) +
  ggtitle("Fuel costs over iterations", "Smoothed over iterations")

print(pFuelCostsIter + facet_wrap(~ year))

print(pFuelCostsYear + facet_grid(technology ~ iteration, scales = "free"))

print(pFuelCostsIter + facet_grid(technology ~ year, scales = "free"))
