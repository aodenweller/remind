...
dataCO2PricePyPSA <- readPyPSAcsv(
    paths = file.path(pyResourcesIterDirs, "co2_price_scenarios.csv")) %>% 
...
# REMIND capacity factors (ancitipation factor based)
...
mapElecBalanceWithdrawal <- c(
  "8" = "FE demand",
  "9" = "SE demand (electrolysis)",
  "10" = "Storage losses (v32_storloss)",
  "11" = "Own consumption fuel extraction",
  "12" = "Export")
