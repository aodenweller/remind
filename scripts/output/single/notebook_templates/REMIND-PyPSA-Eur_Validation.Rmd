...
ggsave("conv_metric_tech.png", p, width = 10, height = 10, dpi = 300)
...
dataDeltaTechAgg <- readGDX(last_fulldata_file, "p32_delta_AVG", restore_zeros = FALSE) %>%
  as_tibble() %>%
  filter(all_regi %in% regions,
