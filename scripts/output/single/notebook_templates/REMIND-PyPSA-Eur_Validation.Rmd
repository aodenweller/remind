...
dataHydroAvailPyPSA <- readPyPSAcsv(
    paths = file.path(pyCouplingDirs, "availability_factors.csv")) %>%
  filter(general_carrier == "hydro")
...
pYear <- ggplot() +
  ...
  labs(x = "Year", y = "Markup ($/MWh)") +
  ggtitle("Markup for electricity prices for electrolysis over years") +
  facet_wrap(~ iteration, scales = "free")
...
pIter <- ggplot() +
  ...
  labs(x = "Iteration", y = "Markup ($/MWh)") +
  scale_x_continuous(breaks = integer_breaks()) +
  ggtitle("Markup for electricity prices for electrolysis over iterations") +
  facet_wrap(~ year, scales = "free")
