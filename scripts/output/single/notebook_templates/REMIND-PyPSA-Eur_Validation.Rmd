...
for (r in regList){
  ...
  pCapfacYear <- ggplot() +
    ...
    geom_point(data = dataCapFacAvgREMIND, aes(x = year, y = p32_PyPSA_CFAvg, color = technology), alpha = 0.5) +
    scale_shape_manual(name = NULL,
                       values = c("Non-avg. value" = 4)) +
    scale_color_manual(
      name = "Technology",
  ...
  pCapfacIter <- ggplot() +
    ...
    geom_point(data = dataCapFacAvgREMIND, aes(x = iteration, y = p32_PyPSA_CFAvg, color = technology), alpha = 0.5) +
    scale_shape_manual(name = NULL,
                       values = c("Non-avg. value" = 4)) +
    scale_color_manual(
      name = "Technology",
...
for (r in regList) {
  ...
  pMarkupYear <- ggplot() +
    ...
    geom_point(data = dataMarkupAvgREMIND, aes(x = year, y = p32_PyPSA_MarkupAvg, color = technology), alpha = 0.5) +
    scale_shape_manual(name = NULL,
                       values = c("Non-avg. value" = 4)) +
    scale_color_manual(
      name = "Technology",
