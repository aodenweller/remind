...
pYear <- ggplot() +
  ...
  scale_color_manual(name = "Technology", values = colorsTech, labels = namesTech) +
  labs(x = "Year", y = "Capacity (GW)") +
  ggtitle("Optimal capacities in REMIND by year") +
  facet_wrap(~ iteration, scales = "free")
...
pIter <- ggplot() +
  ...
  scale_color_manual(name = "Technology", values = colorsTech, labels = namesTech) +
  labs(x = "Iteration", y = "Capacity (GW)") +
  ggtitle("Optimal capacities in REMIND by iteration") +
  facet_wrap(~ year, scales = "free")
...
pGenYear <- ggplot() +
  ...
  ggtitle("Generation in REMIND by year") +
  facet_wrap(~ iteration, scales = "free")
...
pGenIter <- ggplot() +
  ...
  ggtitle("Generation in REMIND by iteration") +
  facet_wrap(~ year, scales = "free")
