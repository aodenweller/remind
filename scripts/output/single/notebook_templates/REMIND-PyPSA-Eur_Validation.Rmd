    ...
    for (i in rmIterations){
      ...
      pGenComp <- ggplot() +
        ...
        geom_col(data = dataSupplyPyPSAploti,
                ...
                width = 1.7) +
        # REMIND supply
        geom_col(data = dataGenREMINDploti,
                mapping = aes(x = year, y = value, fill = technology),
                position = position_stacknudge(x = -1),
                width = 1.7) +
        # Supply legend
        ...
        geom_col(data = dataWithdrawalPyPSAploti,
                ...
                width = 1.7) +
        # REMIND withdrawal
        geom_col(data = dataLoadREMINDploti,
                mapping = aes(x = year, y = -value, fill = "load"),
                position = position_nudge(x = -1),
                width = 1.7) +
        # Withdrawal legend
        scale_fill_manual(
        ...
        # Model border
        geom_col(data = dataGenREMINDplotitot,
                mapping = aes(x = year, y = value, linetype = "REMIND"),
                position = position_nudge(x = -1),
                width = 1.7,
                linewidth = 0.25,
        ...
        ggtitle(paste("Energy balance over years, iteration", i), regSubtitle(r))


      # Plot relative differences
      dataGenDiffplot <- full_join(dataGenREMINDploti, dataSupplyPyPSAploti,
                        by = c("year", "technology")) %>%
...
# Get file paths to configs (to get colours)
fp_configs = [file for directory in py_results_dirs for file in Path(directory).rglob("y*/configs/*.yaml")]

# Read first config yaml file
with open(fp_configs[0], 'r') as file:
